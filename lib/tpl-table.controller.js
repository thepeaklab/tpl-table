      ...
      if (state) {
        if (state.pageBeforeSearch >= 0) {
          ...
          if (state.entriesPerPageCountBeforeSearch > 0) {
            oldEntriesPerPageCount = vm.opts.entriesPerPageCount;
            vm.opts.entriesPerPageCount = state.entriesPerPageCountBeforeSearch; //TODO: callback
          ...
          if (state) {
            if (state.actualPage >= 0) {
              ...
              if (state.actualEntriesPerPageCount > 0) {
                oldEntriesPerPageCount = vm.opts.entriesPerPageCount;
                vm.opts.entriesPerPageCount = state.actualEntriesPerPageCount; //TODO: callback
                this.handleEntriesPerPageCount(vm.opts.entriesPerPageCount, oldEntriesPerPageCount);
              }
